...
# Data directories
dataset_dir = 'plantvillage_dataset/color'  # Change this to your dataset path

# Image size and other constants
IMG_HEIGHT, IMG_WIDTH = 224, 224
BATCH_SIZE = 32
EPOCHS = 15  # Increased number of epochs for fine-tuning
...
callbacks = [
    ...
    ModelCheckpoint('best_model_tomato_vgg16.keras', save_best_only=True),
    ReduceLROnPlateau(monitor='val_loss', factor=0.2, patience=3, min_lr=1e-6)  # Reduce learning rate on plateau
]
...
model.save('crop_disease_model_all_restnet.keras')
